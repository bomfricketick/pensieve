<template>
  <div class="drager_row flex" ref="container" :style="{ width: width, height: height }">
    <div class="drager_top max-h-fit" :style="{ height: top + '%' }">
      <slot name="top"></slot>
    </div>
    <div class="slider_row bg-gray-600 hover:bg-blue-700 active:bg-blue-700" @touchstart.passive="mobileDragRow"
      @mousedown="dragRow" :style="{
        height: sliderWidth + 'px',
        marginTop: -sliderWidth / 1 + 'px',
        marginBottom: -sliderWidth / 1 + 'px',
      }"></div>
